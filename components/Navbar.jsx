...
const links = ['Categories','Past editions', 'Future editions', 'About us', 'Make a donation' ];
...
<div className="flex flex-col lg:flex-row gap-10 align-middle my-auto z-20 lg:mx-auto">
         {links.map((link)=>(
          <span key={link} className="cursor-pointer hover:text-gray-500 transition-all duration-500 text-[#0c0114]">{link}</span>
         ))}
    </div>
    ...
    <span  className="flex-col flex lg:flex-row gap-6 lg:ml-auto align-middle my-auto z-20 w-fit">
