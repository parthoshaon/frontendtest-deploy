...
const links = [{text:'Categories',link:"voting"},{text:'Past editions',link:"celebrated"},{text:'Future editions',link:"futureeditions"}, {text:'About us',link:"awards"}, {text:'Make a donation',link:"donation"} ];
