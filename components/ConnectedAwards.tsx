    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="w-full lg:p-12 p-6 flex flex-col gap-6 lg:pr-0 pr-0">
                    <h1 className="text-xl lg:text-4xl font-bold relative after:w-36 after:h-1.5 after:bg-golden after:rounded-full after:left-1 after:bottom-0 after:absolute">The Connected Awards</h1>
                ...
                <Link href="/awards"><span className="w-fit text-[#EEE8F2] hover:bg-[#EEE8F2] py-3 px-6 rounded bg-darkPurple hover:text-[#3E0563] cursor-pointer transition-all duration-500 ease-in">Learn more</span></Link>
...
<path fillRule="evenodd" clipRule="evenodd" d="M99.9969 180H63.7124C63.7124 163.113 57.0042 146.918 45.0635 134.977C33.1228 123.036 16.9277 116.328 0.0410156 116.328V80.0437C26.5476 80.0547 51.9654 90.5892 70.7084 109.332C89.4514 128.075 99.986 153.493 99.9969 180Z" fill="#FA9706"/>
        ...
        <div className="lg:grid lg:grid-cols-2 grid-cols-1 flex flex-col-reverse text-[#0c0114]">
...
<path fillRule="evenodd" clipRule="evenodd" d="M99.9969 180H63.7124C63.7124 163.113 57.0042 146.918 45.0635 134.977C33.1228 123.036 16.9277 116.328 0.0410156 116.328V80.0437C26.5476 80.0547 51.9654 90.5892 70.7084 109.332C89.4514 128.075 99.986 153.493 99.9969 180Z" fill="#FA9706"/>
              ...
              {images.map((image:StaticImageData, i)=>(
                ...
                {images2.map((image:StaticImageData, i)=>(
                  <div className="w-full h-auto block p-0 m-0" key={Id + i}><Image src={image} layout="responsive"/></div>
                  ))
                }
                  </div>
                  </div>
