...
//       <h1><span className="font-bold text-xl w-1/2 mx-auto">Time to vote your favorite Techie, let's make this amazing!</span></h1>
...
// <span className="flex flex-col-reverse text-left gap-2">{gendererror && <p className="text-xs text-red-400">Please select a gender</p>}<select ref={genderEl} name="gender" id="gender" className={`appearance-none peer outline-none ring-2 ${gendererror? `peer-focus:ring-red-500 ring-red-200` :`ring-[#DCDCDC] focus:ring-gray-300`} p-2 text-gray-500 rounded-sm px-4`}>
//   <option value=""></option>
