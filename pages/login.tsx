...
return router.push('/')
  ...
  return (
    ...
    <div className="bg-white m-auto flex flex-col text-center p-10 lg:w-1/2 w-full gap-2">
      ...
      <span className=" bg-[#D8CDE0]/50 border border-[#D8CDE0] hover:bg-[#D8CDE0] hover:border-[#D8CDE0]/50 transition-all duration-500 ease-in w-full h-auto p-3 flex items-center cursor-pointer"><span className="flex mx-auto gap-1"><span className="w-6 h-6">
