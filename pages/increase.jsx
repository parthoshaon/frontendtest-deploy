  ...
  return (
    <>
      ...
      <div className={`${popUp ? `flex transition-[display] duration-500 ease-in` : `hidden transition-[display] duration-500 ease-out`} flex-col items-center`}>
        ...
        <div onBlur={() => setPopUp(false)} tabIndex={90}  className="fixed z-40 bg-white w-2/5 h-auto p-10 flex flex-col items-center rounded shadow-sm gap-8">
            ...
            <span className="p-3 bg-[#3E0563] text-white font-bold rounded px-8 tracking-wider"><Link href="/voting">Return to voting page</Link></span>
          </div>
        </div>
